     ...
     mx-auto px-[30px] sm:px-[70px] py-[100px] sm:py-[123px]">
      ...
      <section className="flex flex-col sm:flex-row">
        ...
        <img
          ...
          src={'./BD583E5A-C0FA-444F-989C-F8633DBF8D75.png'}
        />
      </section>
        ...
        rounded-sm  my-8 sm:grid sm:grid-cols-3">
          ...
          <div className="pb-[60px] sm:pb-[100px]">
            ...
            <div className="w-[150px]  sm:w-[200px] mx-[80px] ">
              <img alt="first-icon" src={'./first-icon.jpeg'} />
            </div>
          </div>
          ...
          <div className="pb-[60px] sm:pb-[100px]">
            ...
            <div className="w-[150px]  sm:w-[200px] mx-[80px] ">
              <img alt="first-icon" src={"./second-icon.jpeg"} />
            </div>
          </div>
          ...
          <div className="pb-[60px] sm:pb-[100px]">
            ...
            <div className="w-[150px]  sm:w-[200px] mx-[80px] ">
              <img alt="first-icon" src={"./third-icon.jpeg"} />
            </div>
          </div>
